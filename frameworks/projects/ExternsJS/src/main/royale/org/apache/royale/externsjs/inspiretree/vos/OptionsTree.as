...
package org.apache.royale.externsjs.inspiretree.vos
{
    ...
    public class OptionsTree
    {
        ...
        /**
         * allow - noop, Dynamically determine selectable boolean for a node.
         * autoDeselect - true ,Prevent automatic deselection.
         * autoSelectChildren - false, Auto-select children when a parent node is selected, regardless of their visibility.
         * autoSelectOnNodeRemoval - true , .
         * disableDirectDeselection - false, Disallow deselecting a node by clicking on it while selected.
         * mode - default or checkbox. 'default',Checkbox mode auto-selects children, doesn't auto deselect.
         *        mode ['default' | 'tree' | 'checkbox'] 
         * multiple - false, Allow multiple nodes to be selected at a time.
         * require - false, Require at least one selected node.
         *  // Royale
         *  checkedIsSelected: false, CUSTOM PROPERTY Hiedra (in checkbox mode checked <> selected)
         */

...
package org.apache.royale.externsjs.inspiretree.beads.models
{
	...
	public class InspireTreeModel extends ArrayListSelectionModel
	{
		 ...
		 * In InspireTreeModelExt --> tree, itemTreeNode (* jsTree)
		 */
		...
		*/
		...
		protected function itemParentToLabel(item:Object):String
		{
			if(!item || item==null)
				return '';

			if(boundField) // && item.hasOwnProperty(boundField))
				return item[boundField];
			else if(labelField) // && item.hasOwnProperty(labelField))

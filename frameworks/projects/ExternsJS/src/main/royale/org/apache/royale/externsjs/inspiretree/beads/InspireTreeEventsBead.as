...
package org.apache.royale.externsjs.inspiretree.beads
{
	...
	public class InspireTreeEventsBead  extends Strand implements IBead
	{
		...
		private var _nodeChecked:Function;
		public function get nodeChecked():Function{ return _nodeChecked; }
		/**
		 * function onCheckedNode(node:ItemTreeNode, checked:Boolean):void{}
		 * @param value Callback function User checked/unchecked node.
		 */
		public function set nodeChecked(value:Function):void{ _nodeChecked = value; }
		public function onCheckedNodeHandler(treeNode:Object, handler:Function):void
		{
			_nodeChecked( new ItemTreeNode(treeNode), true);
		}
		public function onUncheckedNodeHandler(treeNode:Object, handler:Function):void
		{
			_nodeChecked( new ItemTreeNode(treeNode), false);
		}
        ...
        private var _nodeSelected:Function;
        public function get nodeSelected():Function { return _nodeSelected; }
		/**
		 * function onSelectedNode(node:ItemTreeNode, isLoadEvent:Boolean):void{}
		 * @param value Callback function selected node.
		 */
        public function set nodeSelected(value:Function):void {	_nodeSelected = value; }
		public function onSelectedNodeHandler(treeNode:Object, isLoadEvent:Boolean, handler:Function):void
		{
			_nodeSelected( new ItemTreeNode(treeNode),isLoadEvent);
		}
